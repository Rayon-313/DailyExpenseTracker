...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-surface-950 p-4 relative overflow-hidden">
      <div className="absolute w-[32rem] h-[32rem] rounded-full bg-brand-500/10 blur-3xl -bottom-48 -right-48" />
      <div className="w-full max-w-sm relative">
        <div className="text-center mb-8">
          ...
          <p className="text-surface-400 mt-1 text-sm">Build a more mindful money habit.</p>
        </div>
        <div className="card p-6 sm:p-7">
          <p className="text-brand-300 text-[11px] font-semibold uppercase tracking-[.17em] mb-2">Start your ledger</p>
          <h2 className="page-title text-2xl font-bold text-white mb-6">Create your account</h2>
          ...
          <p className="text-center text-surface-400 text-sm mt-5">
            ...
            <Link to="/login" className="text-brand-300 hover:text-brand-400 font-semibold">Sign In</Link>
          </p>
        </div>
      </div>
    </div>
