  ...
  return (
    <div className="relative" ref={panelRef}>
      <button
        ...
        className={`btn-secondary flex items-center gap-2 ${hasFilters ? 'ring-1 ring-blue-500/50 border-blue-500/50' : ''}`}
      >
      ...
      {isOpen && (
        <div className="absolute right-0 top-11 w-80 bg-surface-900 border border-surface-700 rounded-xl p-5 space-y-4 z-50 shadow-xl">
