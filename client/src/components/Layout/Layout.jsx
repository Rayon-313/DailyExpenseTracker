      ...
      <footer className="border-t border-surface-800">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-xs text-surface-500">
            &copy; {new Date().getFullYear()} paisa. All rights reserved.
          </p>
          <a
            href="https://wa.me/9779840254903"
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 text-xs font-medium text-surface-400 hover:text-emerald-400 transition-colors duration-150"
          >
